...
INSERT INTO `carro_tem_locacao` VALUES (3,7,3),(4,4,4),(5,9,5),(6,37,6);
...
INSERT INTO `carro_tem_reserva` VALUES (1,34,1),(2,21,2);
...
INSERT INTO `cliente` VALUES (1,'Roberto Freitas','25',0,NULL,'12345678901'),(2,'José de Faria','18',0,NULL,'22132344333'),(3,'Maria Rocha','34',1,NULL,'23333455332'),(4,'Bruno de Almeida','19',1,NULL,'11223467432'),(5,'Elias Monteiro','38',0,NULL,'35563223467'),(6,'Gobbi','21',0,NULL,'13473382734'),(7,'Marcus','12',0,NULL,'12635437211'),(8,'Kaique','12',0,NULL,'12345763211'),(9,'Guilherme Gobbi','22',0,NULL,'12342123456'),(10,'Pati','23',0,NULL,'09876543213'),(11,'raul','23',0,NULL,'09855553213'),(12,'Igor Balofo','15',0,NULL,'13409283232'),(13,'Marcus Vinicius','23',0,NULL,'12345678921'),(14,'Hugo','24',0,NULL,'12345123456'),(15,'Penélope','67',0,NULL,'13478946534'),(16,'Gobbigor','22',0,NULL,'56677534556'),(17,'Goku','30',0,NULL,'10922782277');
/*!40000 ALTER TABLE `cliente` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cliente_tem_carro`
--

DROP TABLE IF EXISTS `cliente_tem_carro`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cliente_tem_carro` (
  `id_cliente_tem_carro` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `id_carro` bigint(20) unsigned DEFAULT NULL,
  `id_cliente` bigint(20) unsigned DEFAULT NULL,
  PRIMARY KEY (`id_cliente_tem_carro`),
  UNIQUE KEY `id_cliente_tem_carro` (`id_cliente_tem_carro`),
  KEY `cliente_tem_carro_fk0` (`id_carro`),
  KEY `cliente_tem_carro_fk1` (`id_cliente`),
  CONSTRAINT `cliente_tem_carro_ibfk_1` FOREIGN KEY (`id_carro`) REFERENCES `carro` (`id_carro`),
  CONSTRAINT `cliente_tem_carro_ibfk_2` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cliente_tem_carro`
--

LOCK TABLES `cliente_tem_carro` WRITE;
/*!40000 ALTER TABLE `cliente_tem_carro` DISABLE KEYS */;
INSERT INTO `cliente_tem_carro` VALUES (7,1,15),(8,2,10),(9,17,16),(10,21,17),(11,37,17),(12,3,17);
/*!40000 ALTER TABLE `cliente_tem_carro` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `locacao` VALUES (3,NULL,'2014-11-05',NULL,15,'7',NULL,'2014-11-22'),(4,NULL,'2014-11-05',NULL,15,'4',NULL,'2014-11-22'),(5,NULL,'2014-11-13',NULL,16,'9',NULL,'2014-11-28'),(6,NULL,'2014-11-13',NULL,17,'37',NULL,'2014-11-27');
...
INSERT INTO `manutencao` VALUES (1,'2014-11-13',NULL),(2,'2014-11-13',NULL),(3,'2014-11-25',7);
...
CREATE TABLE `pagamento` (
  ...
  `id_locacao` bigint(20) unsigned DEFAULT NULL,
  `id_reserva` bigint(20) unsigned DEFAULT NULL,
  `dinheiro_cartao` text,
  `credito_debito` text,
  `parcelamento` int(11) DEFAULT NULL,
  `tarifa_desconto` double DEFAULT NULL,
...
INSERT INTO `pagamento` VALUES (1,10,10,NULL,NULL,'2014-11-25',NULL,2,'dinheiro',NULL,NULL,10,50010),(2,NULL,67,NULL,NULL,'2014-11-25',6,NULL,'dinheiro',NULL,NULL,NULL,1500067);
...
INSERT INTO `reserva` VALUES (1,'2014-11-13','2014-11-29','2014-11-14',16,'34',NULL,NULL),(2,'2014-11-13','2014-11-27','2014-11-14',17,'21',NULL,NULL);
...
CREATE TABLE `venda` (
  ...
  KEY `venda_fk0` (`id_carro`),
  KEY `venda_fk1` (`id_pagamento`),
...
INSERT INTO `venda` VALUES (5,NULL,1),(6,NULL,2),(7,NULL,17),(8,NULL,3);
...
-- Dump completed on 2014-11-25 17:34:41
