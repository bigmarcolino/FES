...
CREATE TABLE pagamento_tem_reserva (
 id_pagamento_tem_reserva SERIAL,
 id_pagamento BIGINT UNSIGNED,
 id_reserva BIGINT UNSIGNED
);

ALTER TABLE pagamento_tem_reserva ADD CONSTRAINT PK_pagamento_tem_reserva PRIMARY KEY (id_pagamento_tem_reserva);
...
ALTER TABLE carro ADD CONSTRAINT FK_carro_2 FOREIGN KEY (id_cliente) REFERENCES cliente (id_cliente);
...
ALTER TABLE cliente ADD CONSTRAINT FK_cliente_2 FOREIGN KEY (id_carro) REFERENCES carro (id_carro);
...
ALTER TABLE pagamento_tem_reserva ADD CONSTRAINT FK_pagamento_tem_reserva_0 FOREIGN KEY (id_pagamento) REFERENCES pagamento (id_pagamento);
ALTER TABLE pagamento_tem_reserva ADD CONSTRAINT FK_pagamento_tem_reserva_1 FOREIGN KEY (id_reserva) REFERENCES reserva (id_reserva);
